              ...
              <Colxx xxs="6" sm="4" md="3" lg="2">
                <Card className="mb-4">
                  <CardBody className="text-center">
                    ...
                    <p className="card-text font-weight-semibold mb-0">Pending Orders</p>
              ...
              <Colxx xxs="6" sm="4" md="3" lg="2">
                <Card className="mb-4">
                  <CardBody className="text-center">
                    ...
                    <p className="card-text font-weight-semibold mb-0">Completed Orders</p>
              ...
              <Colxx xxs="6" sm="4" md="3" lg="2">
                <Card className="mb-4">
                  <CardBody className="text-center">
                    ...
                    <p className="card-text font-weight-semibold mb-0">Refund Requests</p>
              ...
              <Colxx xxs="6" sm="4" md="3" lg="2">
                <Card className="mb-4">
                  <CardBody className="text-center">
                    ...
                    <p className="card-text font-weight-semibold mb-0">New Comments</p>
